...
import type { RecyclingStatus as _RecyclingStatus, ScanRecord as _ScanRecord, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllScans(): Promise<Array<[Principal, Array<ScanRecord>]>> {
        if (this.processError) {
            try {
    ...
    async submitScan(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitScan(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_RecyclingStatus_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RecyclingStatus): RecyclingStatus {
    return from_candid_variant_n9(_uploadFile, _downloadFile, value);
}
function from_candid_ScanRecord_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ScanRecord): ScanRecord {
...
function from_candid_record_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    recyclingStatus: _RecyclingStatus;
    bottleId: string;
    pointsEarned: bigint;
    timestamp: _Time;
}): {
    ...
    return {
        recyclingStatus: from_candid_RecyclingStatus_n8(_uploadFile, _downloadFile, value.recyclingStatus),
        bottleId: value.bottleId,
        pointsEarned: value.pointsEarned,
        timestamp: value.timestamp
    };
}
function from_candid_tuple_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, Array<_ScanRecord>]): [Principal, Array<ScanRecord>] {
    return [
        value[0],
...
function from_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "verified" in value ? RecyclingStatus.verified : value;
}
function from_candid_vec_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, Array<_ScanRecord>]>): Array<[Principal, Array<ScanRecord>]> {
    return value.map((x)=>from_candid_tuple_n4(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ScanRecord>): Array<ScanRecord> {
    return value.map((x)=>from_candid_ScanRecord_n6(_uploadFile, _downloadFile, x));
}
